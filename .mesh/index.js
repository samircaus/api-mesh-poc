...
var merger_stitching_1 = __importDefault(require("@graphql-mesh/merger-stitching"));
...
var importedModule$0 = __importStar(require("./sources/CountryDetails/introspectionSchema"));
var importedModule$1 = __importStar(require("./sources/Countries/introspectionSchema"));
...
var importFn = function (moduleId) {
    ...
    switch (relativeModuleId) {
        case ".mesh/sources/CountryDetails/introspectionSchema":
...
function getMeshOptions() {
    return __awaiter(this, void 0, Promise, function () {
        var pubsub, sourcesStore, logger, cache, sources, transforms, additionalEnvelopPlugins, countriesTransforms, countryDetailsTransforms, countriesHandler, countryDetailsHandler, additionalTypeDefs, _a, _b, additionalResolvers, merger;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    countriesTransforms = [];
                    countryDetailsTransforms = [];
                    countriesHandler = new graphql_1.default({
                        name: "Countries",
                    ...
                    countryDetailsHandler = new graphql_1.default({
                        name: "CountryDetails",
                        config: { "endpoint": "https://sandbox.samircaus.workers.dev/graphql" },
                        baseDir: baseDir,
                        cache: cache,
                        pubsub: pubsub,
                        store: sourcesStore.child("CountryDetails"),
                        logger: logger.child("CountryDetails"),
                        importFn: importFn,
                    });
                    sources[0] = {
                        name: 'Countries',
                    ...
                    sources[1] = {
                        name: 'CountryDetails',
                        handler: countryDetailsHandler,
                        transforms: countryDetailsTransforms
                    };
                    additionalTypeDefs = [(0, graphql_2.parse)("extend type Country {\n  displayName: String\n  fullDescription: String\n  hasCapital: Boolean\n  currencySign: String\n  description: String\n}"),];
                ...
                case 1:
                    ...
                    return [4 /*yield*/, Promise.all([
                            Promise.resolve().then(function () { return __importStar(require("/Users/samircaus/git/api-mesh-poc/countries-resolvers.js")); }).then(function (m) { return m.resolvers || m.default || m; })
                        ])];
                case 2:
                    additionalResolvers = _c.sent();
                    merger = new merger_stitching_1.default({
                        cache: cache,
                        pubsub: pubsub,
